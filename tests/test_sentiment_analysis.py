...
class TestAnalyzeSentiment(unittest.TestCase):
    ...
    def test_analyze_sentiment_positive(self, mock_TextBlob):
        ...
        comment = Comment(id='1', text='Great post!', created_at=datetime.now())  # Provide a default value for created_at
    ...
    def test_analyze_sentiment_negative(self, mock_TextBlob):
        ...
        comment = Comment(id='2', text='Poorly written post.', created_at=datetime.now())  # Provide a default value for created_at
